...
// add_action( 'init', __NAMESPACE__ . '\cpt_team', 0 );
...
function cpt_partners() {
	...
	// Modify all the i18ized strings here.
	$labels = [
		'menu_name'          => __( 'Partners', 'cprf' ),
		'name'               => _x( 'Partners', 'post type general name', 'cprf' ),
		'singular_name'      => _x( 'Partner', 'post type singular name', 'cprf' ),
		'name_admin_bar'     => _x( 'Partners', 'add new on admin bar', 'cprf' ),
		'add_new'            => _x( 'Add New', 'thing', 'cprf' ),
		'add_new_item'       => __( 'Add New Partner', 'cprf' ),
		'new_item'           => __( 'New Partner', 'cprf' ),
		'edit_item'          => __( 'Edit Partner', 'cprf' ),
		'view_item'          => __( 'View Partner', 'cprf' ),
		'all_items'          => __( 'All Partners', 'cprf' ),
		'search_items'       => __( 'Search Partners', 'cprf' ),
		'parent_item_colon'  => __( 'Parent Partners:', 'cprf' ),
		'not_found'          => __( 'No partners found.', 'cprf' ),
		'not_found_in_trash' => __( 'No partners found in Trash.', 'cprf' ),
		'featured_image' => __( 'Featured Image', 'cprf' ),
		'set_featured_image' => __( 'Set Featured Image', 'cprf' ),
		'remove_featured_image' => __( 'Remove Featured Image', 'cprf' ),
		'use_featured_image' => __( 'Use as Partner\'s Image', 'cprf' ),
		'insert_into_item' => __( 'Insert into Partner', 'cprf' ),
		'uploaded_to_this_item' => __( 'Uploaded to this Partner', 'cprf' ),
		'items_list' => __( 'Partners list', 'cprf' ),
		'items_list_navigation' => __( 'Partners list navigation', 'cprf' ),
		'filter_items_list' => __( 'Filter Partners list', 'cprf' ),
	];
